...
<head>
    ...
    <title>Tayug Spot Locator</title>
</head>
<style>
    * {
        margin: 0;
    ...
    .banner2 .h3 {
        ...
        max-width: 600px;
        text-align: justify;
        transition: background 1.5s, color 1.5s, border-radius 1.5s, padding 1.5s;
    }
...
<body>
    <header>
        ...
        <ul>
            ...
            <li><a href="spotList.php">Spots</a></li>
    ...
    <footer id="footer">
        ...
        <div class="footer-section">
            <h6>Members</h6>
            <ul>
                <li><a href="https://www.facebook.com/0936.Kennnnnnnnnnnnnnnnnnn"> Christine Antolin</a></li>
                <li><a href="https://www.facebook.com/teroyzkie123">Janiel Capales</a></li>
            </ul>
        </div>
